<?php
// Script para generar registros de pagos de choferes específicamente para abril-mayo 2025
...
echo "=== GENERACIÓN DE PAGOS DE CHOFERES PARA ABRIL-MAYO 2025 ===\n\n";
...
try {
    ...
    // Generar datos aleatorios específicamente para abril-mayo 2025
    $fechaInicio = Carbon::create(2025, 4, 1); // 1 de abril 2025
    ...
    $cantidadPagos = 60;
    echo "Se generarán {$cantidadPagos} registros de pagos de servicios de taxi para abril-mayo 2025.\n";
    ...
    for ($i = 0; $i < $cantidadPagos; $i++) {
        try {
            ...
            // Generar fecha aleatoria dentro del rango (abril-mayo 2025)
    ...
    echo "Total de ingresos para la empresa en abril-mayo 2025: " . number_format($totalImporteEmpresa, 2) . "€\n";
...
echo "\n=== VERIFICACIÓN DE DATOS DE ABRIL-MAYO 2025 ===\n";
...
try {
    ...
    // Mostrar últimos 5 registros del periodo actual
    echo "\nÚltimos 5 registros de abril-mayo 2025:\n";
