...
<body>
    ...
    <div class="breadcrumb-container">
        <div class="container">
            <small>Inicio > Alquiler vehiculos > {{ $vehiculo->tipo->nombre }} > {{ $vehiculo->marca }} >
                {{ $vehiculo->modelo }}</small>
        </div>
    </div>
    ...
    <div class="container vehiculo-detail-section">
            ...
            <div class="col-md-6">
                ...
                <div class="caracteristicas-box">
                    <div class="row caracteristicas">
                        <div class="col-md-6"><i class="fas fa-cogs"></i> Transmisión:
                            {{ $vehiculo->caracteristicas->transmision }}</div>
                        <div class="col-md-6"><i class="fas fa-car"></i> Tipo: {{ $vehiculo->tipo->nombre }}</div>

                        <div class="col-md-6"><i class="fas fa-tachometer-alt"></i> Kilometraje:
                            {{ number_format($vehiculo->kilometraje, 0, ',', '.') }} km</div>
                        <div class="col-md-6"><i class="fas fa-map-marker-alt"></i> Ubicación:
                            {{ $vehiculo->lugar->nombre }}</div>

                        <div class="col-md-6"><i class="fas fa-snowflake"></i> Aire acondicionado:
                            {{ $vehiculo->caracteristicas->aire_acondicionado ? 'Sí' : 'No' }}</div>
                        <div class="col-md-6"><i class="fas fa-sun"></i> Techo solar:
                            {{ $vehiculo->caracteristicas->techo ? 'Sí' : 'No' }}</div>

                        <div class="col-md-6"><i class="fas fa-suitcase"></i> Maletero:
                            {{ $vehiculo->caracteristicas->capacidad_maletero }} L</div>
                    </div>
                </div>
        ...
        <h4 class="mt-5">RECOGE TU VEHÍCULO </h4>
        <!-- Script corto de js para recoger las variables globales -->
        <script>
            window.parkingLocation = {
    ...
    <script src="{{asset('js/map-vehiculo.js')}}"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content shadow" style="border-radius: 16px; background-color: #ffffff;">
                <div class="modal-header"
                    style="background-color: #6f42c1; color: white; border-top-left-radius: 16px; border-top-right-radius: 16px;">
                ...
                <div class="modal-body text-center" style="color: #000;">
                    <p><i class="fas fa-calendar-alt" style="color: #6f42c1; margin-right: 0.5rem;"></i>
                        <strong>Fechas:</strong><br>
                        <span id="modal-fechas"></span>
                    </p>
                    <p><i class="fas fa-clock" style="color: #6f42c1; margin-right: 0.5rem;"></i> <strong>Días
                            seleccionados:</strong> <span id="modal-dias"></span></p>
                    <p><i class="fas fa-euro-sign" style="color: #6f42c1; margin-right: 0.5rem;"></i> <strong>Precio por
                            día:</strong> €<span id="modal-precio-dia"></span></p>
                ...
                <div class="modal-footer justify-content-between"
                    ...
                    <button type="button" class="btn btn-primary" id="btnConfirmarReserva"
                        style="background-color: #6f42c1; border-color: #6f42c1;">Reservar</button>
                </div>
            </div>
        </div>
    </div>
