        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">
                        <i class="fas fa-plus-circle"></i> Registrar Nuevo Pasivo
                    </h5>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.financiero.pasivo.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="fecha_vencimiento" class="col-md-4 col-form-label text-md-right">Fecha de Vencimiento</label>
                            <div class="col-md-6">
                                <input id="fecha_vencimiento" type="date" class="form-control @error('fecha_vencimiento') is-invalid @enderror" name="fecha_vencimiento" value="{{ old('fecha_vencimiento') }}">
                                <small class="form-text text-muted">Opcional. Fecha de vencimiento del pasivo si corresponde.</small>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-warning">
                                    <i class="fas fa-save"></i> Guardar Pasivo
                                </button>
