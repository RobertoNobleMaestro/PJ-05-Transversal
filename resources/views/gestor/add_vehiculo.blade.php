...
<div class="add-user-container">
    <form id="addVehiculoForm" data-url="{{ route('gestor.vehiculos.store') }}" enctype="multipart/form-data">
        ...
        <div id="wizard-step-1" class="wizard-step">
            <h2 class="form-title">Datos del Vehículo</h2>
            <div class="form-grid">
                <div>
            ...
            <div class="form-grid">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="num_puertas" name="num_puertas" min="2" max="6" required>
                    </div>
                </div>
                <div>
                    <div class="form-group">
                        <label for="etiqueta_medioambiental" class="form-label">Etiqueta medioambiental</label>
                        <input type="text" class="form-control" id="etiqueta_medioambiental" name="etiqueta_medioambiental" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="capacidad_maletero" name="capacidad_maletero" min="0" required>
                    </div>
                </div>
            </div>
            <div class="btn-container">
