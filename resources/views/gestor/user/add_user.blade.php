...
@section('title', 'Añadir Usuario Asalariado')
...
@section('content')
    ...
    <div class="add-user-container">
        ...
        <a href="{{ route('gestor.user.index') }}" class="btn btn-cancel" style="margin-bottom: 1.5rem;">
        ...
        <form id="asalariadoWizardForm" data-url="{{ route('gestor.user.store') }}">
            @csrf
                    ...
                    <div class="form-grid">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" max="{{ date('Y-m-d', strtotime('-16 years')) }}">
            ...
            <div id="step-asalariado" style="display:none;">
                    ...
                    <div class="form-grid">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="1" max="31" class="form-control" id="dia_cobro" name="dia_cobro">
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                ...
                <div class="btn-container">
                    ...
                    <button type="button" class="btn btn-submit" onclick="createUser()">Crear</button>
                </div>
            </div>
        </form>
    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestor-add-user.js') }}"></script>
    <script>
